...
case 'waifu':
    ...
    if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
    	  ...
    	  const bb = await haruka.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), MessageType.image)
            ...
            await haruka.sendMessage(from, ButtonssMessages, MessageType.buttonsMessage, {quoted : mek})
	    ...
	    .then(async(result) => {
            for(let i of result.medias){
                if(i.url.includes('mp4')){
                    ...
                    haruka.sendMessage(from,link,video,{quoted: mek,caption: `Type : ${i.type}`})
                } else {
                    let link = await getBuffer(i.url)
                    haruka.sendMessage(from,link,image,{quoted: mek,caption: `Type : ${i.type}`})                  
                }
            }
            });
	    break
...
if (!isGroupAdmins) return reply(lang.admin(groupName))
if (!isBotGroupAdmins) return reply(lang.adminB())
if (args.length < 1) return reply(`\`\`\`ketik .${command}\`\`\``)
if (args[0] === 'on') {
...
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
            ...
            await haruka.sendMessage(from, ButonsMerssages, MessageType.buttonsMessage, {quoted : mek})
                break 
                case 'neko':
                if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
                reply(lang.wait())
            ...
            await haruka.sendMessage(from, BeutonMesages, MessageType.buttonsMessage, {quoted : mek})
                break
    case 'anal':
          if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
          reply(lang.wait())
...
const sa = await haruka.prepareMessage(from, buffer, MessageType.image)
            ...
            await haruka.sendMessage(from, ButonsMessages, MessageType.buttonsMessage, {quoted : mek})
                break 
*/
                case 'nekoh':
                if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
            ...
            await haruka.sendMessage(from, ButtonMessages, MessageType.buttonsMessage, {quoted : mek})
                break
        case 'add':
  try {
  if (!isGroup) return reply(lang.group())
